...
$jform.find('.js-form-spec-comments').val('');$formurl='/mail.php';var d={};d=$jform.serializeArray();if(window.tildaForm.tildapayment&&window.tildaForm.tildapayment.products){d.push({name:'tildapayment',value:JSON.stringify(window.tildaForm.tildapayment)})}else{if($jform.closest('.t706__orderform').length>0){return!1}}
